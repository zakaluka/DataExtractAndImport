...
internal class ExportOptions
{
    [Option('c', "connectionString",
        HelpText =
            "A connection string to connect to the mCase database, can rely on interactive authentication or MFA.",
        Default =
            "data source=localhost; initial catalog=mCASE_ADMIN; integrated security=True; min pool size=10; max pool size=500; multipleactiveresultsets=True; application name=mCaseAdminWebEF6; Connect Timeout=1200; Command Timeout=1200;  TrustServerCertificate=True")]
...
{
    [Option('f', "filename", Required = false, HelpText = "Name of the import file.",
